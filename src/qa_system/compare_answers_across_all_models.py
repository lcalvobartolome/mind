...
path_relevant = "GENERATIONS/outs_good_model_tpc11/relevant"
path_save = "GENERATIONS/outs_good_model_tpc11/answers"
...
paths_ = [path for path in paths_ if path.endswith("thr__dynamic.parquet") and ("llama" in path or "gpt" in path)]#or "llama" in path or "llama" in path #"qwen" in path or 
keep = []
