...
path_relevant = "GENERATIONS/outs_good_model_tpc24/relevant"
path_save = "GENERATIONS/outs_good_model_tpc24/answers"
...
paths_ = [path for path in paths_ if path.endswith("thr__dynamic.parquet") and ("qwen" in path)]#or "llama" in path or "llama" in path
#import pdb; pdb.set_trace()
keep = []#or "llama" in path or "gpt" in path
