...
# DATA #####
############
path_orig_en = pathlib.Path(
    "/export/usuarios_ml4ds/lbartolome/Repos/umd/LinQAForge/data/source/corpus_rosie/corpus_pass_en_tr.parquet")
path_orig_es = pathlib.Path(
    "/export/usuarios_ml4ds/lbartolome/Repos/umd/LinQAForge/data/source/corpus_rosie/corpus_pass_es_tr.parquet")
path_source = pathlib.Path(
    "/export/usuarios_ml4ds/lbartolome/Repos/umd/LinQAForge/data/source/corpus_rosie/passages/multi_blade_filtered/df_1.parquet")
path_model = pathlib.Path(
    "/export/usuarios_ml4ds/lbartolome/Repos/umd/LinQAForge/data/models/MULTI_BLADE_FILTERED/poly_rosie_v2_1_20")
...
if pathlib.Path(f"index_store_es_tpc_{tpc}.pkl").exists():
    ...
    index = Index(
        corpus=df_es_tpc.text.values.tolist(),
        doc_ids=df_es_tpc.doc_id.values.tolist())
...
cg = ClaimsGenerator(
    do_train=True, model_type="llama", open_ai_model="gpt-4o",
...
qa = QAnswerer(
    model_type="llama", open_ai_model="gpt-4o",
