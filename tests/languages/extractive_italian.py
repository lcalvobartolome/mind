...
print('leyendo')
INPUT_PATH = "/export/usuarios01/ivgomez/mind/tests/data_final/dataset_it_con_resumen_EA.parquet"
OUTPUT_PATH = "/export/usuarios01/ivgomez/mind/tests/data_final/dataset_it_con_resumen_EA3.parquet"
...
def resumir_classifier_batch(textos):
    ...
    for text in textos:
        try:
            ...
            # 🔥 Simulación de clasificador: score con norma del embedding
