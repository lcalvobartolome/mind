...
def main():
    ...
    rosie_corpus.generate_tm_tr_corpus(path_save_tr, level="document", sample=0.5)
    ...
    model = PolylingualTM(
        lang1="EN",
        lang2="ES",
        model_folder= pathlib.Path("/export/usuarios_ml4ds/lbartolome/Repos/umd/LinQAForge/data/models/rosie_test_1"),
        num_topics=8
    )
